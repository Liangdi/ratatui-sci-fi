...
- **57 个组件** —— 28 个基础 / 表单 / 指示 / 信息组件 + 10 个高感官特效组件 + 19 个数据图表组件,全部按 ratatui 0.30 的 `Widget` / `StatefulWidget` 标准实现。
...
│   ├── widgets/                 # 57 个组件(基础 / 表单 / 指示 / 信息 / 特效 / 数据图表)
...
- [x] 八大主题 + 57 个组件(基础 / 表单 / 指示 / 信息 / 特效 / 数据图表)
